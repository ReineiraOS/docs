...
export default function Callout({
  ...
  return (
    ...
    >
      ...
      <div className="text-[14px] leading-[1.6] text-docs-text-secondary [&_code]:bg-docs-bg-code [&_code]:border [&_code]:border-docs-border-default [&_code]:rounded [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[13px] [&_a]:text-brand-primary [&_a]:font-medium [&_strong]:text-docs-text-primary [&_strong]:font-semibold">
        {children}
      </div>
    </div>
  );
